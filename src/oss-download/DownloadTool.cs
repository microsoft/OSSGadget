...
{
    internal class DownloadTool : OSSGadget
    {
        /// <summary>
        /// The options for downloading
        /// </summary>
        internal class Options
        {
            ...
            internal bool DownloadMetadataOnly { get; set; }
            ...
            internal IEnumerable<string>? Targets { get; set; }
        ...
        /// <summary>
        /// The entrypoint for running DownloadTool
        /// </summary>
