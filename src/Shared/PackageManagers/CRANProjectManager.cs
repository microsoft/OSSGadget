...
namespace Microsoft.CST.OpenSource.PackageManagers
{
    ...
    internal class CRANProjectManager : BaseProjectManager
    {
        ...
        public CRANProjectManager(IHttpClientFactory httpClientFactory, IManagerProvider<IManagerMetadata>? provider, string destinationDirectory) : base(httpClientFactory, provider, destinationDirectory)
        {
        }
        
        public CRANProjectManager(IManagerProvider<IManagerMetadata>? provider, string destinationDirectory) : base(provider, destinationDirectory)
        {
        }
