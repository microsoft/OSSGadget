...
namespace Microsoft.CST.OpenSource.Shared
{
    ...
    ///     Attributes: None Caveats: Does not work very well with monorepos Lower confidence scores may not
    ///     point to right repos There is no verification done to ensure that the source repo found was for
    ///     the package Cannot be absolutely certain about the source repo without manual intervention
    /// </summary>
