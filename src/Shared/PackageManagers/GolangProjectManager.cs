...
namespace Microsoft.CST.OpenSource.PackageManagers
{
    ...
    internal class GolangProjectManager : BaseProjectManager
    {
        ...
        public GolangProjectManager(IHttpClientFactory httpClientFactory, string destinationDirectory, IManagerProvider? provider = null) : base(httpClientFactory, destinationDirectory, provider)
        {
        }
