...
namespace Microsoft.CST.OpenSource.PackageManagers
{
    ...
    internal class CPANProjectManager : BaseProjectManager
    {
        ...
        public CPANProjectManager(IHttpClientFactory httpClientFactory, IManagerProvider<IManagerMetadata>? provider, string destinationDirectory) : base(httpClientFactory, provider, destinationDirectory)
        {
        }
        
        public CPANProjectManager(IManagerProvider<IManagerMetadata>? provider, string destinationDirectory) : base(provider, destinationDirectory)
        {
        }
